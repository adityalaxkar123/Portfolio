...
const About = ({isDarkMode}) => {
  return (
    ...
    transition={{duration:0.6}}
         className="w-54 sm:w-80 rounded-3xl max-w-none">
          <Image
    ...
    transition={{duration:0.6,delay:0.8}}
         className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            ...
            professional expertise in the field. Throughout my carees, I have
            had the privilege of collaborating with prestigious organisation,
    ...
    whileHover={{scale:1.05}}
                ...
                hover:-translate-y-1 duration-500 hover:shadow-black
                 border-gray-400 rounded-xl p-6 cursor-pointer
    ...
    transition={{duration:1.3,delay:0.5}}
          ...
          font-Ovo dark:text-white/80">Tools I used</motion.h4>
