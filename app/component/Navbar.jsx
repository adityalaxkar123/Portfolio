         ...
         flex items-center justify-between z-50
          ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm": "" }`}>
            ...
            <div className='flex items-center gap-4'>
                ...
                <a href="#contact" className='h-12 font-Ovo hidden lg:flex items-center gap-3 px-10 border border-gray-500 rounded-full ml-4'>Contact <Image src={assets.arrow_icon} alt='contact image' className='w-3'/></a>
