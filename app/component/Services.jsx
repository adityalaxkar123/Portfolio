...
const Services = () => {
  return (
    ...
    transition={{duration:0.5,delay:0.7}} 
      className='text-center max-w-2xl mx-auto mt-5 mb-1 font-Ovo'>I am a frontend developer from rajasthan , india with 2 months of experience in
      GirlScript summer of code</motion.p>
        <motion.div
        initial={{opacity:0}}
    whileInView={{opacity:1}}
