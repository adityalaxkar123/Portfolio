...
const Work = ({isDarkMode}) => {
  return (
    ...
    transition={{duration:0.6,delay:0.9}}
         className='grid grid-cols-auto my-10
         gap-5 dark:text-black'>
            ...
            transition={{duration:0.3}}
                ...
                px-5 flex items-center justify-between duration-500
    ...
    transition={{duration:0.5,delay:1.1}}
         ...
         text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 m-auto my-20
         hover:bg-lightHover
          duration-500 
