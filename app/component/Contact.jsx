  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-center max-w-2xl mx-auto mt-5 mb-1 font-Ovo"
      >
      ...
      >
        <div className=" grid grid-cols-auto gap-6 mt-10 mb-8">
          <motion.input
            ...
            type="text"
            className="flex-1 h-10 outline-none border-[0.5px]
          ...
          <motion.input
            ...
            className="flex-1 h-10 outline-none border-[0.5px] dark:bg-darkHover/30 dark:border-white/90 border-gray-400 rounded-md bg-white "
            required
            name="email"
          />
        </div>
